                                ...
                                return (
                                    <div className="col-3 mx-1" key={index}>
                                        <div className="card mb-3">
                                            ...
                                            <Link to={"infoCard/" + urlTest.replace("/", "")} ><button type="button" className="btn btn-primary">Learn More</button></Link> <i className="far fa-heart" onClick={(e) => actions.getLikes(e)}></i>
                                            </div>
                                        </div>
                                    </div>
                                )
